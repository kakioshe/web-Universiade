...
<div class="container center">
		...
		<div class ="container distance">
			<div class ="row vertical-align">
				<div class="col-md-3">
					<img src="Pictures/logo/soccer.png" alt="Logo Soccer" width="100%">
				</div>
				<div class="col-md-9">
					<div class = "info">
						<h4><span class="titleLomba">Tournament Sepak Bola</span></h4>
					</div>
				</div>
			</div>
			<div class ="row">
				<div class="col-md-8 infoLomba">
					...
					<p><span>Jumlah Pemain:</span> 22 Orang (11 di arena pertandingan)</p>
					<p><span>Official:</span> 1 pelatih 1 manager (optional)</p>
					<p><span>Biaya pendaftaran:</span> Rp1.300.000,- + WO Rp200.000,-</p>
					<p><span>Cabang:</span> Putra</p>
					<p><span>Hadiah:</span>
					<ol>
						<li>Piala</li>
						<li>Sertifikat</li>
