...
<div class="container center">
		...
		<div class ="container distance">
			<div class ="row vertical-align">
				<div class="col-md-3">
					<img src="Pictures/logo/futsal.png" alt="Logo Futsal" width="100%">
				</div>
				<div class="col-md-9">
					<div class = "info">
						<h4><span class="titleLomba">Tournament Futsal</span></h4>
					</div>
				</div>
			</div>
			<div class ="row">
				<div class="col-md-8 infoLomba">
					...
					<p><span>Jumlah Pemain:</span> Maksimal 12 orang, Minimal 4 orang</p>
					<p><span>Official:</span> 1 pelatih 1 manager (optional)</p>
					<p><span>Biaya pendaftaran:</span> Rp800.000,- + WO Rp200.000,-</p>
