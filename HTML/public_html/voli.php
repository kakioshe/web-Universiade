...
<div class="container center">
		...
		<div class ="container distance">
			<div class ="row vertical-align">
				<div class="col-md-3">
					<img src="Pictures/logo/voli.png" alt="Logo Voli" width="100%">
				</div>
				<div class="col-md-9">
					<div class = "info">
						<h4><span class="titleLomba">Tournament Voli</span></h4>
					</div>
				</div>
			</div>
			<div class ="row">
				<div class="col-md-8 infoLomba">
					...
					<p><span>Jumlah Pemain:</span> 12 Orang</p>
					<p><span>Official:</span> 1 pelatih 1 manager (optional)</p>
					<p><span>Biaya pendaftaran:</span> Rp750.000,- + WO Rp100.000,- (DIKEMBALIKAN)</p>
