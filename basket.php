...
<body>
	...
	<div class = "container center">
		<a href="#"><img src="Pictures/lomba-polos.jpg" alt="Daftar Lomba" width="80%"></a>
	</div>

<div class="container center">
		<a href="competition.php"> <img src="Pictures/register.png" width="30%"> </a>
</div>
		...
		<div class ="container">
			<div class ="row vertical-align">
				<div class="col-md-3">
					<img src="Pictures/logo/basket.png" alt="Logo Basket" width="100%">
				</div>
				<div class="col-md-9">
					<div class = "info">
						<h4><span class="titleLomba">Tournament Basket</span></h4>
					</div>
				</div>
			</div>
			<div class ="row">
				<div class="col-md-8 infoLomba">
					<p><span>Waktu penyelenggaraan:</span> 29 September-7 Oktober</p>
					<p><span>Jumlah Pemain:</span> 15 Orang (12 di arena pertandingan)</p>
					<p><span>Official:</span> 1 pelatih 1 manager (optional)</p>
					<p><span>Biaya pendaftaran:</span> Rp1.200.000,- + WO Rp100.000,- (DIKEMBALIKAN)</p>
					<p><span>Cabang:</span> Putra &amp; Putri</p>
					<p><span>Hadiah:</span>
					<ol>
						<li>Piala</li>
						<li>Sertifikat</li>
